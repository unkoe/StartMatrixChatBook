...
![下载客户端](../_static/mac-shadowsockDownload.png)
...
![安装客户端](../_static/mac-shadowsocksIcon.png)

将 "ShadowsocksX-NG" 拖移到 “访达”里面的 “应用程序”。

!["ShadowsocksX-NG" 移动到 "访达" 里面的 "应用程序"](../_static/mac-shadowsocksDrag.gif)

在 "应用程序" 中双击 "ShadowsocksX-NG" > 选择 "打开"。

![选择打开](../_static/mac-NGprompt.png)
...
![服务器设置，打开ss](../_static/mac-shadowsocksSetting.png)
